...
class FriendController extends Controller
{
    ...
    public function getPendingOutFriends(Request $request)
    {
        ...
        $result = User::whereIn('id', $recipients)->where('type', $user->type)->active()->select(['id', 'name', 'last_name', 'avatar', 'nickname', 'type'])->paginate(12);
    ...
    public function getPendingInFriends(Request $request)
    {
        ...
        $result = User::whereIn('id', $senders)->where('type', $user->type)->active()->select(['id', 'name', 'last_name', 'avatar', 'nickname', 'type'])->paginate(12);
