				...
				<div class="panel-body  pa-0">
					<div class="profile-box">
						...
						<div class="profile-info text-center">
							...
							<h5 class="block mt-10 mb-25 weight-500 capitalize-font txt-danger">{{ nickname }}</h5>
						</div>
					</div>
				</div>
			</div>
                                                ...
                                                <div class="radio-list">
                                                    <div class="radio-inline pl-0" v-for="(value, key) in types">
                                                        <span class="radio radio-info">
                                                        	<input type="radio" :value="key" v-model="user.type">
                                                        	<label>{{ value }}</label>
                                                        </span>
                                                    </div>
												</div>
                                    ...
                                    <div class="row">
    									<div class="col-md-12">
                                            <div class="form-group">
    											...
    											<textarea class="form-control" rows="5" placeholder="" v-model="user.description"></textarea>
    										</div>
                                        </div>
                                    </div>
                                    <div class="row">
        ...
        getUser() {
            ...
            if (token !== null) 
            {
                this.$http.get(
                    ...
                    this.user.second_name = user.second_name,
                    ...
                    this.user.min_sponsor_fee = user.min_sponsor_fee;
                    this.user.description = user.description;
                    this.user.overlay = user.overlay;
